...
import bannersectiongroceries from '../assets/img/bannersectiongroceries.jpg'
import Image from 'next/image';
import imgproducts from '../assets/img/img-products.jpg'
import { Button } from 'react-bootstrap';
import { MdOutlineShoppingCart } from "react-icons/md";

export default function Sectiongroceries() {
  return (
    <>
...
<Card className='border-0'>
    ...
    <a href='/groceries'>
<Image placeholder="blur" className='w-100'  src={bannersectiongroceries} alt="product logo" />
</a>        
    </CardHeader>
