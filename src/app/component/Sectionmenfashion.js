...
import bannersectionmenfashion from '../assets/img/bannersectionmenfashion.jpg'
import Image from 'next/image';
import imgproducts from '../assets/img/img-products.jpg'
import { Button } from 'react-bootstrap';
import { MdOutlineShoppingCart } from "react-icons/md";

export default function Sectionmenfashion() {
  return (
    <>
...
<Card className='border-0'>
    ...
    <a href='/fashion'>
<Image placeholder="blur" className='w-100'  src={bannersectionmenfashion} alt="product logo" />
</a>      
    </CardHeader>
