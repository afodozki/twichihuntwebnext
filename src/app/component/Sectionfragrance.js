...
import bannersectionfragrance from '../assets/img/bannersectionfragrance.jpg'
import Image from 'next/image';
import imgproducts from '../assets/img/img-products.jpg'
import { Button } from 'react-bootstrap';
import { MdOutlineShoppingCart } from "react-icons/md";

export default function Sectionfragrance() {
  return (
    <>
...
<Card className='border-0'>
    ...
    <a href='/beauty'>
<Image placeholder="blur" className='w-100'  src={bannersectionfragrance} alt="product logo" />
</a>      
    </CardHeader>
